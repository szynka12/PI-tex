    ...
    \section{Podział konstrukcji na moduły}
        \subsection{Układ napędowy - przekładnia mechanizmu}
           \subsubsection{Ciąg główny}
           		...
           		Układ taktujący naprzemiennie blokuje i pozwala na ruch całego mehanizmu.
           		Kiedy przekłądnia jest odblokowana moement siły jest przekazywany przez zestaw przekładni do koła wychwytowego i dowskazówek połączonych z ciągiem głownym poprzez mechanizm wskazowy.
           		Ciąg główny składa się z 4 kół zębatych o zarysie ewolwentnym, z koła wychwytowego oraz z 4 zębników połączonych z poszczególnymi kołami.
  				Każdy z zębników ma 12 zębów.
  				
  				Ukłąd składa się z następujących elmentów (patrz rysunek \ref{}):
  				\begin{description}
  					\item[Koło główne] - jest ono połączone z magazynem energii zegara. Posiada ono 96 zębów.
  					\item[Zębnik nr 1] - wspołpracuje z kołem głownym.
  					\item[Koło nr 1] - jest połączone z zębnikiem nr 1. Posiada 72 zęby.
  					\item[Zębnik nr 2] - współracuje z kołem nr 1.
  					...
  					\item[Koło wychwytowe] - jest połaczone z zębnikiem nr 4. Posiada 36 niesymetrycznych zębów.
  				\end{description}
  				Razem koła zapewniają przełożenie 600:1.
  				Biorąc pod uwagę, że koło wychwytowe wykonuje 1200 obrotów na jeden dzień pracy (koło ma 36 zębów; mechanizm taktujący pozwala na przesunięcie o jeden ząb na 2 sekundy czyli pół założonego okresu wahadła) przełożenia zostały dobrane w ten sposób aby otrzymać odpowiednie prędkośći obrotowe wskazówek.
  				Koło główne wykonuje 2 obroty w iągu jednego dnia.
  				
  			\subsubsection{Mechanizm wskazowy} 
  				
  				Mechanizm wskazowy składa się z trzech kół zębatych oraz dwóch zębników:
  				\begin{description}
  					\item[Koło centralne] - współpracuje z kołem nr 1. Posiada 48 zębów.
  					\item[Zebnik nr 5] - jest połaczony z kołem centralnym. Posiada 15 zębów.
  					\item[Koło godzinowe nr 1] - wspólpracuje z zebnikiem nr 5. Posiada 45 zębów. 
  					\item[Zębnik nr 6] - jest połączony z kołem godzinowym nr 1. Posiada 12 zębów.
  					\item[Koło godzinowe nr 2] - współracuje z zebnikiem nr 6. Posiada 48 zębów. 
  				\end{description} 
  				Koło centralne jest jednoczenie kołem połaczonym ze wskazówką minutową. Koła godzinowe zapewniają razem przełożenie 1:12.
